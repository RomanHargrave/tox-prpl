 ...
 * - on_file_data
 */
void ToxPRPL_Tox_onFileControl(Tox*, int32_t, uint8_t, uint8_t, uint8_t, uint8_t const *, uint16_t, void*);

void ToxPRPL_Tox_onFileRequest(Tox*, int32_t, uint8_t, uint64_t, uint8_t const *, uint16_t, void*);

void ToxPRPL_Tox_onFileDataReceive(Tox*, int32_t, uint8_t, uint8_t const *, uint16_t, void*);
